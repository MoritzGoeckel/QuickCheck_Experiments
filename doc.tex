...
On the other hand it turns out that after QuickCheck found a bug, it tends to allways find it agian. Therefore the bug either has to be fixed or the test case has to be addapted to continue testing. Before that testing with QuickCheck can hardly continue. The creators of QuickCheck state "QuickCheck is very likely to \[always\] report the most common bug on every run". \cite{Arts06}
